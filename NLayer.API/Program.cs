...
builder.Services.AddDbContext<AppDbContext>(x=>
{
    ...
    {
        option.MigrationsAssembly(Assembly.GetAssembly(typeof(AppDbContext)).GetName().Name); // Migrationýn bulunduðu assembly i iþaret ettik. appsetting.json'da baðlantý cümleciði.
    });
});
